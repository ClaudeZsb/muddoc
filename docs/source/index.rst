...
**Muddoc** is a documentation of `mud <https://mud.dev/>`_ written by mud
developers and focg buidlers, especially for native `solidity
<https://docs.soliditylang.org/en/latest/>`_ developers. We think that `mud's
official documentation <https://mud.dev/introduction>`_ is not particularly
